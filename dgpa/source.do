gl bases="C:\PNNBMTH_2022\Estimacion2022\PTotal\bases"
gl data="C:\PNNBMTH_2022\Estimacion2022\PTotal\data"
gl temp="C:\PNNBMTH_2022\Estimacion2022\PTotal\temp"
gl log="C:\PNNBMTH_2022\Estimacion2022\PTotal\log"

log using "$log\programa_ninios_ENIGH.scml", replace
...
display in red "Población de 0 a 23 años con orfandad materna o partena por entidades federativas"
...
merge 1:1 folioviv foliohog numren using "$bases\poblacion.dta", nogenerate keep (1 3)
...
svy:total n menorA24 p_pot esPoblacionObjetivoA cumplecriteriosA, nolstretch cformat(%9.0f)
...
clear all
*Se realiza la caracterización para conocer a los grupos prioriarios 
